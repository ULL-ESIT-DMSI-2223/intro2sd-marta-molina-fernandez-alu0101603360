...
El resumen del {{ site.data.summary.capitulos[0] }} del libro {{ site.data.summary.titulo }} está en el post [Summary of Introduction to systems Development](https://ull-esit-dmsi-2223.github.io/intro2sd-marta-molina-fernandez-alu0101603360/summaries/intro2sd/)
